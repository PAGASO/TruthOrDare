...
@synthesize arrDelegateTruth, arrDelegateDare;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    RootViewController *rootObject = [[RootViewController alloc] initWithNibName:@"RootViewController" bundle:nil];
    ...
    flgUpdate = FALSE;
    playerCount = 0;
    arrDelegateTruth = [[NSMutableArray alloc] init];
    arrDelegateDare = [[NSMutableArray alloc] init];
...
- (void)createEditableCopyOfDatabaseIfNeeded 
{
    ...
    if (success) 
        return;
    NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"TruthDair.db"];
